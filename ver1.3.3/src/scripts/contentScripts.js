...
window.onload=function(){
  ...
  // else{
    ...
    //       if(domain=="carriercentral.amazon.co.jp/"||domain=="amazon.co.jp"||domain=="amazon.com"){
    ...
    //         if(domain=="direct.smbc.co.jp"||domain=="smbc.co.jp"){
    ...
    //         if(domain=="www.smbc-card.com"||domain=="smbc-card.com"){
    ...
    //       if(domain=="api.saisoncard.co.jp"||domain=="saisoncard.co.jp"){
    ...
    //       console.log("メルカリ検知");
    //       if(domain=="jp.mercari.com"||domain=="mercari.com"){
    ...
    //       if(domain=="www.etc-meisai.jp"||domain=="etc-meisai.jp"){
    ...
    //         if(domain=="id.my.softbank.jp"||domain=="my.softbank.jp"||domain=="softbank.jp"){
